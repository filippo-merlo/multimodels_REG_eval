...
VOCAB_IMAGE_W = 1000
VOCAB_IMAGE_H = 1000
from scripts.ferret_gemma.conversation import conv_templates, SeparatorStyle
from scripts.ferret_gemma.builder import load_pretrained_model

from scripts.ferret_gemma.mm_utils import tokenizer_image_token, process_images
