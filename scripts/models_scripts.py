...
def load_model(model_name, device, model_dir, cache_dir):
    ...
    if model_name == 'Salesforce/xgen-mm-phi3-mini-instruct-singleimg-r-v1.5':
        ...
        def generate(model, image, bbox):
            ...
            prompt = (
                ...
                f"<|user|>\n<image>What is the object in this part <bbox>[{x1}, {y1}][{x2}, {y2}]</bbox> of the image? Only output the object's name if one is present. If no object is present, output 'Nothing'—no extra text.<|end|>\n<|assistant|>\n"
    ...
    if model_name == 'Salesforce/xgen-mm-phi3-mini-instruct-r-v1':
        ...
        def generate(model, image, bbox):
            ...
            prompt="<grounding>What is the object in <phrase>this part</phrase> of the image? Only output the object's name if one is present. If no object is present, output 'Nothing'—no extra text. Answer:"
            ...
            return processed_text.replace("What is the object in this part of the image? Only output the object's name if one is present. If no object is present, output 'Nothing'—no extra text. Answer: ", "")
        ...
        def generate(model, image, bbox):
            ...
            print('point:',x1, y1)
            prompt=f"What is the object at point x = {int(x1)}, y = {int(y1)} of the image? Only output the object's name if one is present. If no object is present, output 'Nothing'—no extra text."
            ...
            messages = [
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": f"What is the object in this part of the image <|box_start|>({x1},{y1}),({x2},{y2})<|box_end|>? Only output the object's name if one is present. If no object is present, output 'Nothing'—no extra text."
                        },
                    ],
                }
            ]
