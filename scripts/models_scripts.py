...
def load_model(model_name, device, model_dir, cache_dir):
    ...
    if model_name == 'Salesforce/xgen-mm-phi3-mini-instruct-r-v1':
        ...
        def generate(model, image, bbox):
            ...
            return processed_text.replace(prompt, "")
        ...
        def generate(model, image, bbox):
            ...
            question = f"What is the object in this part of the image [{x1}, {y1}, {x2}, {y2}]? Answer with the object's name only, or 'Nothing' if no object is present."
